...
const BtnWhatsapp = () => {
    return (
        <div className='bg-white shadow-inner inline-block align-baseline rounded px-3 py-2 flex flex-col items-center'>
        <Link to='https://web.whatsapp.com/send?phone=5534984262755' target='_blank'>
            <img id='btn-whapp' src={wa} alt='whatsapp' />
            <h3 className='text-green-900 text-2xl font-bold'>Clique Aqui!</h3>
